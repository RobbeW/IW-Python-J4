...
for i in range(len(cases)):
    ...
    # generate test expression
    #
    expression_name = f"discriminant({test[0]}, {test[1]}, {test[2]})"
    result = module.discriminant( test[0], test[1], test[2] )
    ...
    yamldata[0]['contexts'][i]["testcases"].append( testcase)
     ...
     # generate test expression
    #
    expression_name = f"aantal_oplossingen({test[0]}, {test[1]}, {test[2]})"
    result = module.aantal_oplossingen( test[0], test[1], test[2] )
